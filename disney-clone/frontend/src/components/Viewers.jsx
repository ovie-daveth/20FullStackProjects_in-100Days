...
const Viewers = () => {
  ...
  return (
    <div className='grid lg:grid-cols-5 md:grid-cols-3 grid-cols-1 mt-2 gap-2 px-6'>
        {views.map((view, index) => (
        <div key={index} className="block relative group border-[2px] border-gray-500 rounded-md">
          <img src={view} alt={`view${index}`} />
          <video autoPlay muted loop className='group-hover:block hidden absolute top-0 opacity-80'>
